...
def main():
    ...
    def process_final_combined_dataframe(df_orig):
        ...
        if '項目名' in df.columns:
            ...
            df.loc[is_not_final_approval & bracketed &
                   not_undeployed, '完了区分'] = 1
            df.loc[is_not_final_approval & (
                df['項目名'] == "【未展開】"), '完了区分'] = 0
    ...
    with col1:
        sel_y = st.selectbox(
            "生産計画年", years, index=years.index(str(today.year)))
    with col2:
                    ...
                    if not fcr_df.empty:
                        ...
                        if not display_df.empty:
                            ...
                            if muki == '横':
                                ...
                                heatmap_height = num_B_labels * 27 + 200
