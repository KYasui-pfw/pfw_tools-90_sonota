...
|   2 | SYS_C002849424                 | CHECK                          | "PUCH_ODR_CD" IS NOT NULL      |
|   3 | SYS_C002849425                 | CHECK                          | "WH_CD" IS NOT NULL            |
|   4 | SYS_C002849426                 | CHECK                          | "NON_NO_ITEM_TYP" IS NOT NULL  |
|   5 | SYS_C002849427                 | CHECK                          | "PLANT_CD" IS NOT NULL         |
|   6 | SYS_C002849428                 | CHECK                          | "PUCH_ODR_QTY" IS NOT NULL     |
|   7 | SYS_C002849429                 | CHECK                          | "UNIT_COST_TYP" IS NOT NULL    |
|   8 | SYS_C002849430                 | CHECK                          | "UNIT_COST" IS NOT NULL        |
|   9 | SYS_C002849431                 | CHECK                          | "PROCESSING_COST" IS NOT NULL  |
|  10 | SYS_C002849432                 | CHECK                          | "MATERIAL_COST" IS NOT NULL    |
|  11 | SYS_C002849433                 | CHECK                          | "OTHER_OVERHEADS" IS NOT NULL  |
|  12 | SYS_C002849434                 | CHECK                          | "DISC_AMOUNT" IS NOT NULL      |
|  13 | SYS_C002849435                 | CHECK                          | "PUCH_ODR_AMOUNT" IS NOT NULL  |
|  14 | SYS_C002849436                 | CHECK                          | "PUCH_ODR_GNR_TYP" IS NOT NULL |
|  15 | SYS_C002849437                 | CHECK                          | "PUCH_ODR_INST_SLIP_ISS_FLG" IS NOT NULL |
|  16 | SYS_C002849438                 | CHECK                          | "PUCH_ODR_STS_TYP" IS NOT NULL |
|  17 | SYS_C002849439                 | CHECK                          | "INSPC_CMPLT_FLG" IS NOT NULL  |
|  18 | SYS_C002849440                 | CHECK                          | "SPL_ITEM_TYP" IS NOT NULL     |
|  19 | SYS_C002849441                 | CHECK                          | "ACPT_INSPC_TYP" IS NOT NULL   |
|  20 | SYS_C002849442                 | CHECK                          | "INV_CTRL_FLG" IS NOT NULL     |
|  21 | SYS_C002849443                 | CHECK                          | "DETAIL_NO" IS NOT NULL        |
|  22 | SYS_C002849444                 | CHECK                          | "EXCH_RATE" IS NOT NULL        |
|  23 | SYS_C002849445                 | CHECK                          | "TAX_RATE_1" IS NOT NULL       |
|  24 | SYS_C002849446                 | CHECK                          | "TAX_RATE_2" IS NOT NULL       |
|  25 | SYS_C002849447                 | CHECK                          | "TAX_RATE_3" IS NOT NULL       |
|  26 | SYS_C002849448                 | CHECK                          | "NET_AMOUNT" IS NOT NULL       |
|  27 | SYS_C002849449                 | CHECK                          | "TAX_AMOUNT_1" IS NOT NULL     |
|  28 | SYS_C002849450                 | CHECK                          | "TAX_AMOUNT_2" IS NOT NULL     |
|  29 | SYS_C002849451                 | CHECK                          | "TAX_AMOUNT_3" IS NOT NULL     |
|  30 | SYS_C002849452                 | CHECK                          | "AMOUNT_INCLUDE_TAX" IS NOT NULL |
|  31 | SYS_C002849453                 | CHECK                          | "HOME_CUR_AMOUNT" IS NOT NULL  |
|  32 | SYS_C002849454                 | CHECK                          | "TAX_ROUND_TYP" IS NOT NULL    |
|  33 | SYS_C002849455                 | CHECK                          | "NON_NO_ITEM_FLG" IS NOT NULL  |
|  34 | SYS_C002849456                 | CHECK                          | "PUCH_ODR_EDI_ISS_FLG" IS NOT NULL |
|  35 | SYS_C002849457                 | CHECK                          | "PUCH_ODR_FAX_ISS_FLG" IS NOT NULL |
|  36 | SYS_C002849458                 | CHECK                          | "PUCH_ODR_MAIL_ISS_FLG" IS NOT NULL |
|  37 | SYS_C002849459                 | CHECK                          | "ODR_CANCEL_SLIP_ISS_FLG" IS NOT NULL |
|  38 | SYS_C002849460                 | CHECK                          | "CREATED_DATE" IS NOT NULL     |
|  39 | SYS_C002849461                 | CHECK                          | "CREATED_BY" IS NOT NULL       |
|  40 | SYS_C002849462                 | CHECK                          | "CREATED_PRG_NM" IS NOT NULL   |
|  41 | SYS_C002849463                 | CHECK                          | "UPDATED_DATE" IS NOT NULL     |
|  42 | SYS_C002849464                 | CHECK                          | "UPDATED_BY" IS NOT NULL       |
|  43 | SYS_C002849465                 | CHECK                          | "UPDATED_PRG_NM" IS NOT NULL   |
|  44 | SYS_C002849466                 | CHECK                          | "MODIFY_COUNT" IS NOT NULL     |
|  45 | SYS_C002849467                 | CHECK                          | "ODR_QTY" IS NOT NULL          |
|  46 | SYS_C002849468                 | CHECK                          | "PUCH_ODR_TYP" IS NOT NULL     |
|  47 | SYS_C002849469                 | CHECK                          | "FIRST_ITEM_FLG" IS NOT NULL   |
|  48 | SYS_C002849470                 | CHECK                          | "FIRST_INSPEC_FLG" IS NOT NULL |
...
|  32 | SAMPLE_SIZE                    | 805918                                                                                               |
|  33 | LAST_ANALYZED                  | 2026/01/12 22:05:29                                                                                  |
|  34 | PARTITIONED                    | NO                                                                                                   |
|  35 | IOT_TYPE                       |                                                                                                      |
|  36 | TEMPORARY                      | N                                                                                                    |
|  37 | SECONDARY                      | N                                                                                                    |
