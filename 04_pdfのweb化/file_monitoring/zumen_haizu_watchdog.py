...
# --- 設定項目 ---
MONITOR_ROOT = r"d:\zumenhai"
OUTPUT_DIR = r"D:\file_monitor\zumenhai"
PROJECT_NAME = "zumenhai"
...
class ZumenWatchdog:
    ...
    def __init__(self):
        ...
        # ファイルパス
        self.structure_path = self.output_dir / "haizu_folder_structure.json"
        self.metadata_path = self.output_dir / "haizu_folder_metadata.json"
        self.log_path = self.output_dir / "haizu_monitor_log.txt"
