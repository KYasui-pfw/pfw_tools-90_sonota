...
def main():
    ...
    # M0410工程マスタを読み込み
    print("\n=== M0410工程マスタ読み込み ===")
    m0410_file = os.path.join(r"C:\Dev\90_tools\90_temp\11_品目工程・品目構成（マシニング）\input", "M0410_工程マスタ.csv")
    try:
    ...
    pefin_zenkatei_dict = {}
    try:
        pefin_file = os.path.join(r"C:\Dev\90_tools\90_temp\11_品目工程・品目構成（マシニング）\input", "PEFINソート.csv")
        pefin_df = None
    ...
    for hmcd, group in grouped:
        ...
        for idx, row_data in enumerate(ordered_data, 1):
            ...
            # 前工程をキーにしてSRCD/SRPRICEを統合取得、完成部番をキーにしてLDTIMEを取得
