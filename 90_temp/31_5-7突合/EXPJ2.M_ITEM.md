...
|   2 | SYS_C002800763                 | CHECK                          | "ITEM_CD" IS NOT NULL          |
|   3 | SYS_C002800764                 | CHECK                          | "HIGH_LEVEL_NO" IS NOT NULL    |
|   4 | SYS_C002800765                 | CHECK                          | "MRP_ODR_TYP" IS NOT NULL      |
|   5 | SYS_C002800766                 | CHECK                          | "OUTSIDE_TYP" IS NOT NULL      |
|   6 | SYS_C002800767                 | CHECK                          | "STOCK_UNIT_FLG" IS NOT NULL   |
|   7 | SYS_C002800768                 | CHECK                          | "PKG_UNIT_QTY" IS NOT NULL     |
|   8 | SYS_C002800769                 | CHECK                          | "UNIT_QTY_TYP" IS NOT NULL     |
|   9 | SYS_C002800770                 | CHECK                          | "ODR_LT" IS NOT NULL           |
|  10 | SYS_C002800771                 | CHECK                          | "FIXED_LT" IS NOT NULL         |
|  11 | SYS_C002800772                 | CHECK                          | "PROP_LT" IS NOT NULL          |
|  12 | SYS_C002800773                 | CHECK                          | "SAFETY_LT" IS NOT NULL        |
|  13 | SYS_C002800774                 | CHECK                          | "ISSUE_LT" IS NOT NULL         |
|  14 | SYS_C002800775                 | CHECK                          | "PROP_LOT_SIZE" IS NOT NULL    |
|  15 | SYS_C002800776                 | CHECK                          | "ITEM_SPOIL" IS NOT NULL       |
|  16 | SYS_C002800777                 | CHECK                          | "SAFETY_STOCK" IS NOT NULL     |
|  17 | SYS_C002800778                 | CHECK                          | "LOT_SIZING_TYP" IS NOT NULL   |
|  18 | SYS_C002800779                 | CHECK                          | "MAX_PERIOD" IS NOT NULL       |
|  19 | SYS_C002800780                 | CHECK                          | "MAX_ODR_QTY" IS NOT NULL      |
|  20 | SYS_C002800781                 | CHECK                          | "ODR_POINT" IS NOT NULL        |
|  21 | SYS_C002800782                 | CHECK                          | "FIXED_ODR_QTY" IS NOT NULL    |
|  22 | SYS_C002800783                 | CHECK                          | "MIN_ODR_QTY" IS NOT NULL      |
|  23 | SYS_C002800784                 | CHECK                          | "MUL_ODR_QTY" IS NOT NULL      |
|  24 | SYS_C002800785                 | CHECK                          | "ISSUE_TYP" IS NOT NULL        |
|  25 | SYS_C002800786                 | CHECK                          | "MPS_FLG" IS NOT NULL          |
|  26 | SYS_C002800787                 | CHECK                          | "ACPT_INSPC_TYP" IS NOT NULL   |
|  27 | SYS_C002800788                 | CHECK                          | "PRODUCT_TYP" IS NOT NULL      |
|  28 | SYS_C002800789                 | CHECK                          | "UNIT_WEIGHT" IS NOT NULL      |
|  29 | SYS_C002800790                 | CHECK                          | "ABC_TYP" IS NOT NULL          |
|  30 | SYS_C002800791                 | CHECK                          | "OPR_RSLT_TYP" IS NOT NULL     |
|  31 | SYS_C002800792                 | CHECK                          | "SPL_ITEM_TYP" IS NOT NULL     |
|  32 | SYS_C002800793                 | CHECK                          | "MODIFY_COUNT" IS NOT NULL     |
|  33 | SYS_C002800794                 | CHECK                          | "U_SLIP_PS_OUT_FLG" IS NOT NULL |
|  34 | SYS_C002800795                 | CHECK                          | "U_OPR_INST_SLIP_FLG" IS NOT NULL |
|  35 | SYS_C002800796                 | CHECK                          | "INV_TYP_1" IS NOT NULL        |
|  36 | SYS_C002800797                 | CHECK                          | "INV_TYP_2" IS NOT NULL        |
|  37 | SYS_C002800798                 | CHECK                          | "KANAGATA_UMU" IS NOT NULL     |
|  38 | SYS_C002800799                 | CHECK                          | "ITEM_VERSION" IS NOT NULL     |
|  39 | SYS_C002800800                 | CHECK                          | "PUCH_ODR_LT" IS NOT NULL      |
|  40 | SYS_C002800801                 | CHECK                          | "PUCH_FIXED_LT" IS NOT NULL    |
|  41 | SYS_C002800802                 | CHECK                          | "PUCH_PROP_LT" IS NOT NULL     |
|  42 | SYS_C002800803                 | CHECK                          | "PUCH_SAFETY_LT" IS NOT NULL   |
|  43 | SYS_C002800804                 | CHECK                          | "PUCH_ISSUE_LT" IS NOT NULL    |
|  44 | SYS_C002800805                 | CHECK                          | "ITEM_INSPECT_FLG" IS NOT NULL |
|  45 | SYS_C002800806                 | CHECK                          | "SIZE_X" IS NOT NULL           |
|  46 | SYS_C002800807                 | CHECK                          | "SIZE_Y" IS NOT NULL           |
|  47 | SYS_C002800808                 | CHECK                          | "SIZE_Z" IS NOT NULL           |
|  48 | SYS_C002800809                 | CHECK                          | "WIP_ODR_LT" IS NOT NULL       |
|  49 | SYS_C002800810                 | CHECK                          | "WIP_FIXED_LT" IS NOT NULL     |
|  50 | SYS_C002800811                 | CHECK                          | "WIP_PROP_LT" IS NOT NULL      |
|  51 | SYS_C002800812                 | CHECK                          | "WIP_SAFETY_LT" IS NOT NULL    |
|  52 | SYS_C002800813                 | CHECK                          | "WIP_ISSUE_LT" IS NOT NULL     |
|  53 | SYS_C002800814                 | CHECK                          | "ISSUE_OUT_TYP" IS NOT NULL    |
|  54 | SYS_C002800815                 | CHECK                          | "PARTS_INSIDE_PUCH_FLG" IS NOT NULL |
|  55 | SYS_C002800816                 | CHECK                          | "ESTIMATE_FLG" IS NOT NULL     |
|  56 | SYS_C002800817                 | CHECK                          | "FIRST_ITEM_FLG" IS NOT NULL   |
|  57 | SYS_C002800818                 | CHECK                          | "PARTS_ISSUEL_TYP" IS NOT NULL |
|  58 | SYS_C002800819                 | CHECK                          | "PARTS_LIST_FLG" IS NOT NULL   |
...
|  32 | SAMPLE_SIZE                    | 2000                                                                                                 |
|  33 | LAST_ANALYZED                  | 2025/10/03 9:21:05                                                                                   |
|  34 | PARTITIONED                    | NO                                                                                                   |
|  35 | IOT_TYPE                       |                                                                                                      |
|  36 | TEMPORARY                      | N                                                                                                    |
|  37 | SECONDARY                      | N                                                                                                    |
