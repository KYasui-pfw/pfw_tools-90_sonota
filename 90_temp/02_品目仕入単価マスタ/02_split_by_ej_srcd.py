...
WORK_FILE = os.path.join(INPUT_DIR, "14_品目工程work.csv")
OUTPUT_DIR = os.path.join(BASE_DIR, "02_EJから取得")
...
for record in ej_found_list:
    ...
    mk020_record = {
        ...
        'VALQTY': float(record.get('M_PUCH_SIZE', 0)),  # M_PUCH_SIZE
        'PRICE': float(record.get('UNIT_COST', 0)),  # UNIT_COST
        'NOTE': '',  # 空欄
        'SYOKAIHINKBN': '1'  # 固定値"1"
    }
