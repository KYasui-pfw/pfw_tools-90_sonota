...
|   2 | SYS_C002779816                 | CHECK                          | "ITEM_CD" IS NOT NULL          |
|   3 | SYS_C002779817                 | CHECK                          | "HIGH_LEVEL_NO" IS NOT NULL    |
|   4 | SYS_C002779818                 | CHECK                          | "MRP_ODR_TYP" IS NOT NULL      |
|   5 | SYS_C002779819                 | CHECK                          | "OUTSIDE_TYP" IS NOT NULL      |
|   6 | SYS_C002779820                 | CHECK                          | "STOCK_UNIT_FLG" IS NOT NULL   |
|   7 | SYS_C002779821                 | CHECK                          | "PKG_UNIT_QTY" IS NOT NULL     |
|   8 | SYS_C002779822                 | CHECK                          | "UNIT_QTY_TYP" IS NOT NULL     |
|   9 | SYS_C002779823                 | CHECK                          | "ODR_LT" IS NOT NULL           |
|  10 | SYS_C002779824                 | CHECK                          | "FIXED_LT" IS NOT NULL         |
|  11 | SYS_C002779825                 | CHECK                          | "PROP_LT" IS NOT NULL          |
|  12 | SYS_C002779826                 | CHECK                          | "SAFETY_LT" IS NOT NULL        |
|  13 | SYS_C002779827                 | CHECK                          | "ISSUE_LT" IS NOT NULL         |
|  14 | SYS_C002779828                 | CHECK                          | "PROP_LOT_SIZE" IS NOT NULL    |
|  15 | SYS_C002779829                 | CHECK                          | "ITEM_SPOIL" IS NOT NULL       |
|  16 | SYS_C002779830                 | CHECK                          | "SAFETY_STOCK" IS NOT NULL     |
|  17 | SYS_C002779831                 | CHECK                          | "LOT_SIZING_TYP" IS NOT NULL   |
|  18 | SYS_C002779832                 | CHECK                          | "MAX_PERIOD" IS NOT NULL       |
|  19 | SYS_C002779833                 | CHECK                          | "MAX_ODR_QTY" IS NOT NULL      |
|  20 | SYS_C002779834                 | CHECK                          | "ODR_POINT" IS NOT NULL        |
|  21 | SYS_C002779835                 | CHECK                          | "FIXED_ODR_QTY" IS NOT NULL    |
|  22 | SYS_C002779836                 | CHECK                          | "MIN_ODR_QTY" IS NOT NULL      |
|  23 | SYS_C002779837                 | CHECK                          | "MUL_ODR_QTY" IS NOT NULL      |
|  24 | SYS_C002779838                 | CHECK                          | "ISSUE_TYP" IS NOT NULL        |
|  25 | SYS_C002779839                 | CHECK                          | "MPS_FLG" IS NOT NULL          |
|  26 | SYS_C002779840                 | CHECK                          | "ACPT_INSPC_TYP" IS NOT NULL   |
|  27 | SYS_C002779841                 | CHECK                          | "PRODUCT_TYP" IS NOT NULL      |
|  28 | SYS_C002779842                 | CHECK                          | "UNIT_WEIGHT" IS NOT NULL      |
|  29 | SYS_C002779843                 | CHECK                          | "ABC_TYP" IS NOT NULL          |
|  30 | SYS_C002779844                 | CHECK                          | "OPR_RSLT_TYP" IS NOT NULL     |
|  31 | SYS_C002779845                 | CHECK                          | "SPL_ITEM_TYP" IS NOT NULL     |
|  32 | SYS_C002779846                 | CHECK                          | "MODIFY_COUNT" IS NOT NULL     |
|  33 | SYS_C002779847                 | CHECK                          | "U_SLIP_PS_OUT_FLG" IS NOT NULL |
|  34 | SYS_C002779848                 | CHECK                          | "U_OPR_INST_SLIP_FLG" IS NOT NULL |
|  35 | SYS_C002779849                 | CHECK                          | "INV_TYP_1" IS NOT NULL        |
|  36 | SYS_C002779850                 | CHECK                          | "INV_TYP_2" IS NOT NULL        |
|  37 | SYS_C002779851                 | CHECK                          | "KANAGATA_UMU" IS NOT NULL     |
|  38 | SYS_C002779852                 | CHECK                          | "ITEM_VERSION" IS NOT NULL     |
|  39 | SYS_C002779853                 | CHECK                          | "PUCH_ODR_LT" IS NOT NULL      |
|  40 | SYS_C002779854                 | CHECK                          | "PUCH_FIXED_LT" IS NOT NULL    |
|  41 | SYS_C002779855                 | CHECK                          | "PUCH_PROP_LT" IS NOT NULL     |
|  42 | SYS_C002779856                 | CHECK                          | "PUCH_SAFETY_LT" IS NOT NULL   |
|  43 | SYS_C002779857                 | CHECK                          | "PUCH_ISSUE_LT" IS NOT NULL    |
|  44 | SYS_C002779858                 | CHECK                          | "ITEM_INSPECT_FLG" IS NOT NULL |
|  45 | SYS_C002779859                 | CHECK                          | "SIZE_X" IS NOT NULL           |
|  46 | SYS_C002779860                 | CHECK                          | "SIZE_Y" IS NOT NULL           |
|  47 | SYS_C002779861                 | CHECK                          | "SIZE_Z" IS NOT NULL           |
|  48 | SYS_C002779862                 | CHECK                          | "WIP_ODR_LT" IS NOT NULL       |
|  49 | SYS_C002779863                 | CHECK                          | "WIP_FIXED_LT" IS NOT NULL     |
|  50 | SYS_C002779864                 | CHECK                          | "WIP_PROP_LT" IS NOT NULL      |
|  51 | SYS_C002779865                 | CHECK                          | "WIP_SAFETY_LT" IS NOT NULL    |
|  52 | SYS_C002779866                 | CHECK                          | "WIP_ISSUE_LT" IS NOT NULL     |
|  53 | SYS_C002779867                 | CHECK                          | "ISSUE_OUT_TYP" IS NOT NULL    |
|  54 | SYS_C002779868                 | CHECK                          | "PARTS_INSIDE_PUCH_FLG" IS NOT NULL |
|  55 | SYS_C002779869                 | CHECK                          | "ESTIMATE_FLG" IS NOT NULL     |
|  56 | SYS_C002779870                 | CHECK                          | "FIRST_ITEM_FLG" IS NOT NULL   |
|  57 | SYS_C002779871                 | CHECK                          | "PARTS_ISSUEL_TYP" IS NOT NULL |
|  58 | SYS_C002779872                 | CHECK                          | "PARTS_LIST_FLG" IS NOT NULL   |
...
|  32 | SAMPLE_SIZE                    | 1441247                                                                                              |
|  33 | LAST_ANALYZED                  | 2025/09/01 22:03:02                                                                                  |
|  34 | PARTITIONED                    | NO                                                                                                   |
|  35 | IOT_TYPE                       |                                                                                                      |
|  36 | TEMPORARY                      | N                                                                                                    |
|  37 | SECONDARY                      | N                                                                                                    |
