...
|   2 | SYS_C002786383                 | CHECK                          | "PUCH_ODR_CD" IS NOT NULL      |
|   3 | SYS_C002786384                 | CHECK                          | "WH_CD" IS NOT NULL            |
|   4 | SYS_C002786385                 | CHECK                          | "NON_NO_ITEM_TYP" IS NOT NULL  |
|   5 | SYS_C002786386                 | CHECK                          | "PLANT_CD" IS NOT NULL         |
|   6 | SYS_C002786387                 | CHECK                          | "PUCH_ODR_QTY" IS NOT NULL     |
|   7 | SYS_C002786388                 | CHECK                          | "UNIT_COST_TYP" IS NOT NULL    |
|   8 | SYS_C002786389                 | CHECK                          | "UNIT_COST" IS NOT NULL        |
|   9 | SYS_C002786390                 | CHECK                          | "PROCESSING_COST" IS NOT NULL  |
|  10 | SYS_C002786391                 | CHECK                          | "MATERIAL_COST" IS NOT NULL    |
|  11 | SYS_C002786392                 | CHECK                          | "OTHER_OVERHEADS" IS NOT NULL  |
|  12 | SYS_C002786393                 | CHECK                          | "DISC_AMOUNT" IS NOT NULL      |
|  13 | SYS_C002786394                 | CHECK                          | "PUCH_ODR_AMOUNT" IS NOT NULL  |
|  14 | SYS_C002786395                 | CHECK                          | "PUCH_ODR_GNR_TYP" IS NOT NULL |
|  15 | SYS_C002786396                 | CHECK                          | "PUCH_ODR_INST_SLIP_ISS_FLG" IS NOT NULL |
|  16 | SYS_C002786397                 | CHECK                          | "PUCH_ODR_STS_TYP" IS NOT NULL |
|  17 | SYS_C002786398                 | CHECK                          | "INSPC_CMPLT_FLG" IS NOT NULL  |
|  18 | SYS_C002786399                 | CHECK                          | "SPL_ITEM_TYP" IS NOT NULL     |
|  19 | SYS_C002786400                 | CHECK                          | "ACPT_INSPC_TYP" IS NOT NULL   |
|  20 | SYS_C002786401                 | CHECK                          | "INV_CTRL_FLG" IS NOT NULL     |
|  21 | SYS_C002786402                 | CHECK                          | "DETAIL_NO" IS NOT NULL        |
|  22 | SYS_C002786403                 | CHECK                          | "EXCH_RATE" IS NOT NULL        |
|  23 | SYS_C002786404                 | CHECK                          | "TAX_RATE_1" IS NOT NULL       |
|  24 | SYS_C002786405                 | CHECK                          | "TAX_RATE_2" IS NOT NULL       |
|  25 | SYS_C002786406                 | CHECK                          | "TAX_RATE_3" IS NOT NULL       |
|  26 | SYS_C002786407                 | CHECK                          | "NET_AMOUNT" IS NOT NULL       |
|  27 | SYS_C002786408                 | CHECK                          | "TAX_AMOUNT_1" IS NOT NULL     |
|  28 | SYS_C002786409                 | CHECK                          | "TAX_AMOUNT_2" IS NOT NULL     |
|  29 | SYS_C002786410                 | CHECK                          | "TAX_AMOUNT_3" IS NOT NULL     |
|  30 | SYS_C002786411                 | CHECK                          | "AMOUNT_INCLUDE_TAX" IS NOT NULL |
|  31 | SYS_C002786412                 | CHECK                          | "HOME_CUR_AMOUNT" IS NOT NULL  |
|  32 | SYS_C002786413                 | CHECK                          | "TAX_ROUND_TYP" IS NOT NULL    |
|  33 | SYS_C002786414                 | CHECK                          | "NON_NO_ITEM_FLG" IS NOT NULL  |
|  34 | SYS_C002786415                 | CHECK                          | "PUCH_ODR_EDI_ISS_FLG" IS NOT NULL |
|  35 | SYS_C002786416                 | CHECK                          | "PUCH_ODR_FAX_ISS_FLG" IS NOT NULL |
|  36 | SYS_C002786417                 | CHECK                          | "PUCH_ODR_MAIL_ISS_FLG" IS NOT NULL |
|  37 | SYS_C002786418                 | CHECK                          | "ODR_CANCEL_SLIP_ISS_FLG" IS NOT NULL |
|  38 | SYS_C002786419                 | CHECK                          | "CREATED_DATE" IS NOT NULL     |
|  39 | SYS_C002786420                 | CHECK                          | "CREATED_BY" IS NOT NULL       |
|  40 | SYS_C002786421                 | CHECK                          | "CREATED_PRG_NM" IS NOT NULL   |
|  41 | SYS_C002786422                 | CHECK                          | "UPDATED_DATE" IS NOT NULL     |
|  42 | SYS_C002786423                 | CHECK                          | "UPDATED_BY" IS NOT NULL       |
|  43 | SYS_C002786424                 | CHECK                          | "UPDATED_PRG_NM" IS NOT NULL   |
|  44 | SYS_C002786425                 | CHECK                          | "MODIFY_COUNT" IS NOT NULL     |
|  45 | SYS_C002786426                 | CHECK                          | "ODR_QTY" IS NOT NULL          |
|  46 | SYS_C002786427                 | CHECK                          | "PUCH_ODR_TYP" IS NOT NULL     |
|  47 | SYS_C002786428                 | CHECK                          | "FIRST_ITEM_FLG" IS NOT NULL   |
|  48 | SYS_C002786429                 | CHECK                          | "FIRST_INSPEC_FLG" IS NOT NULL |
...
|  32 | SAMPLE_SIZE                    | 777231                                                                                               |
|  33 | LAST_ANALYZED                  | 2025/09/09 22:53:37                                                                                  |
|  34 | PARTITIONED                    | NO                                                                                                   |
|  35 | IOT_TYPE                       |                                                                                                      |
|  36 | TEMPORARY                      | N                                                                                                    |
|  37 | SECONDARY                      | N                                                                                                    |
